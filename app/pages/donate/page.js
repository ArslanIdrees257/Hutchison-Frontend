...
export default function Blog(){
 ...
 <Header/>
    <div className="mx-auto max-w-2xl mt-5 p-14 lg:text-center">
        <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl  underline lg:text-balance">Donate now for Guide Dogs.</p>
    </div>
          ...
          <div className="mb-6 grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input datepicker="true" datepicker-format="mm/yy" id="card-expiration-input" type="text" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-9 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="12/23" required />
              </div>
            </div>
            <div>
        ...
        <div className="mt-6 grow sm:mt-8 lg:mt-0">
          <div className="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd className="text-base font-bold text-gray-900 dark:text-white">GBP 10.00</dd>
            </dl>
          </div>

          <div className="mt-6 flex items-center justify-center gap-8">
            <Image className="h-8 w-auto dark:hidden"  width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/paypal.svg" alt="" />
            <Image className="hidden h-8 w-auto dark:flex" width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/paypal-dark.svg" alt="" />
            <Image className="h-8 w-auto dark:hidden" width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/visa.svg" alt="" />
            <Image className="hidden h-8 w-auto dark:flex" width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/visa-dark.svg" alt="" />
            <Image className="h-8 w-auto dark:hidden" width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/mastercard.svg" alt="" />
            <Image className="hidden h-8 w-auto dark:flex" width={10} height={10} src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/mastercard-dark.svg" alt="" />
          </div>
        </div>
      </div>

      <p className="mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8 lg:text-left">
        Payment processed by <a href="#" title="" className="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">Dogs and Origin</a> for <a href="#" title="" className="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">Guide Dogs UK</a>
        - United Kingdom
      </p>
    </div>
  </div>
